...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'id', title: '库存号', width:160, sort: true, fixed: true}
      ,{field:'goods_id', title: '商品id', width:160}
      ,{field:'size_id', title: '尺码', width:160, sort:true }
      ,{field:'num', title: '库存余量',  width:160}
